...
DIM SHARED CONTENT AS STRING
CRLF = CHR$(13) + CHR$(10)
PRINT "Billy www host  "
...
REM Added Shared data 7-05-2017 All Day
connections = 0
host = _OPENHOST("TCP/IP:8088")
DO
    _LIMIT 700
    IF dataload = 0 THEN
        PRINT "Loading Data "
        file$ = "/home/john/Downloads/qb64/Billy/billywwwhost.txt"
...
SELECT CASE client_method(c)
    ...
    CASE METHOD_GET
        'Say something interesting and change to suit your IP or domain
        _LIMIT 700
        respond c, "HTTP/1.1 200 OK", CONTENT
        GOTO skipsave

        m$ = "<html><head></head><body>"
        m$ = m$ + "<iframe src=" + CHR$(34) + "http://sw.twilightparadox.com:9501" + CHR$(34) + " style=" + CHR$(34) + "border:1px  solid" + CHR$(59) + CHR$(34) + " name=" + CHR$(34) + "Street" + CHR$(34) + " scroling=" + CHR$(34) + "auto" + CHR$(34) + " frameborder=" + CHR$(34) + "yes" + " align=" + CHR$(34) + "center" + CHR$(34) + " height = " + CHR$(34) + "100%" + CHR$(34) + " width = " + CHR$(34) + "100%" + CHR$(34) + ">" + "</iframe>"
        m$ = m$ + "<iframe src=" + CHR$(34) + "http://sw.twilightparadox.com:9502" + CHR$(34) + " style=" + CHR$(34) + "border:1px  solid" + CHR$(59) + CHR$(34) + " name=" + CHR$(34) + "Street" + CHR$(34) + " scroling=" + CHR$(34) + "auto" + CHR$(34) + " frameborder=" + CHR$(34) + "yes" + " align=" + CHR$(34) + "center" + CHR$(34) + " height = " + CHR$(34) + "100%" + CHR$(34) + " width = " + CHR$(34) + "100%" + CHR$(34) + ">" + "</iframe>"
        m$ = m$ + "<iframe src=" + CHR$(34) + "http://sw.twilightparadox.com:9503" + CHR$(34) + " style=" + CHR$(34) + "border:1px  solid" + CHR$(59) + CHR$(34) + " name=" + CHR$(34) + "Street" + CHR$(34) + " scroling=" + CHR$(34) + "auto" + CHR$(34) + " frameborder=" + CHR$(34) + "yes" + " align=" + CHR$(34) + "center" + CHR$(34) + " height = " + CHR$(34) + "100%" + CHR$(34) + " width = " + CHR$(34) + "100%" + CHR$(34) + ">" + "</iframe>"
        m$ = m$ + "<iframe src=" + CHR$(34) + "http://sw.twilightparadox.com:9504" + CHR$(34) + " style=" + CHR$(34) + "border:1px  solid" + CHR$(59) + CHR$(34) + " name=" + CHR$(34) + "Street" + CHR$(34) + " scroling=" + CHR$(34) + "auto" + CHR$(34) + " frameborder=" + CHR$(34) + "yes" + " align=" + CHR$(34) + "center" + CHR$(34) + " height = " + CHR$(34) + "100%" + CHR$(34) + " width = " + CHR$(34) + "100%" + CHR$(34) + ">" + "</iframe>"
        m$ = m$ + "<iframe src=" + CHR$(34) + "http://sw.twilightparadox.com:9505" + CHR$(34) + " style=" + CHR$(34) + "border:1px  solid" + CHR$(59) + CHR$(34) + " name=" + CHR$(34) + "Street" + CHR$(34) + " scroling=" + CHR$(34) + "auto" + CHR$(34) + " frameborder=" + CHR$(34) + "yes" + " align=" + CHR$(34) + "center" + CHR$(34) + " height = " + CHR$(34) + "100%" + CHR$(34) + " width = " + CHR$(34) + "100%" + CHR$(34) + ">" + "</iframe>"
        m$ = m$ + "<iframe src=" + CHR$(34) + "http://sw.twilightparadox.com:9506" + CHR$(34) + " style=" + CHR$(34) + "border:1px  solid" + CHR$(59) + CHR$(34) + " name=" + CHR$(34) + "Street" + CHR$(34) + " scroling=" + CHR$(34) + "auto" + CHR$(34) + " frameborder=" + CHR$(34) + "yes" + " align=" + CHR$(34) + "center" + CHR$(34) + " height = " + CHR$(34) + "100%" + CHR$(34) + " width = " + CHR$(34) + "100%" + CHR$(34) + ">" + "</iframe>"
        REM For Low end Phone Adjust to suite
        'm$ = m$ + "<iframe src=" + CHR$(34) + "http://sw.twilightparadox.com:9501" + CHR$(34) + " style=" + CHR$(34) + "border:1px  solid" + CHR$(59) + CHR$(34) + " name=" + CHR$(34) + "Street" + CHR$(34) + " scroling=" + CHR$(34) + "auto" + CHR$(34) + " frameborder=" + CHR$(34) + "yes" + " align=" + CHR$(34) + "center" + CHR$(34) + " height = " + CHR$(34) + "150%" + CHR$(34) + " width = " + CHR$(34) + "200%" + CHR$(34) + ">" + "</iframe>"
        'm$ = m$ + "<iframe src=" + CHR$(34) + "http://sw.twilightparadox.com:9502" + CHR$(34) + " style=" + CHR$(34) + "border:1px  solid" + CHR$(59) + CHR$(34) + " name=" + CHR$(34) + "Street" + CHR$(34) + " scroling=" + CHR$(34) + "auto" + CHR$(34) + " frameborder=" + CHR$(34) + "yes" + " align=" + CHR$(34) + "center" + CHR$(34) + " height = " + CHR$(34) + "150%" + CHR$(34) + " width = " + CHR$(34) + "200%" + CHR$(34) + ">" + "</iframe>"
        'm$ = m$ + "<iframe src=" + CHR$(34) + "http://sw.twilightparadox.com:9503" + CHR$(34) + " style=" + CHR$(34) + "border:1px  solid" + CHR$(59) + CHR$(34) + " name=" + CHR$(34) + "Street" + CHR$(34) + " scroling=" + CHR$(34) + "auto" + CHR$(34) + " frameborder=" + CHR$(34) + "yes" + " align=" + CHR$(34) + "center" + CHR$(34) + " height = " + CHR$(34) + "150%" + CHR$(34) + " width = " + CHR$(34) + "200%" + CHR$(34) + ">" + "</iframe>"
        'm$ = m$ + "<iframe src=" + CHR$(34) + "http://sw.twilightparadox.com:9504" + CHR$(34) + " style=" + CHR$(34) + "border:1px  solid" + CHR$(59) + CHR$(34) + " name=" + CHR$(34) + "Street" + CHR$(34) + " scroling=" + CHR$(34) + "auto" + CHR$(34) + " frameborder=" + CHR$(34) + "yes" + " align=" + CHR$(34) + "center" + CHR$(34) + " height = " + CHR$(34) + "150%" + CHR$(34) + " width = " + CHR$(34) + "200%" + CHR$(34) + ">" + "</iframe>"
        'm$ = m$ + "<iframe src=" + CHR$(34) + "http://sw.twilightparadox.com:9505" + CHR$(34) + " style=" + CHR$(34) + "border:1px  solid" + CHR$(59) + CHR$(34) + " name=" + CHR$(34) + "Street" + CHR$(34) + " scroling=" + CHR$(34) + "auto" + CHR$(34) + " frameborder=" + CHR$(34) + "yes" + " align=" + CHR$(34) + "center" + CHR$(34) + " height = " + CHR$(34) + "150%" + CHR$(34) + " width = " + CHR$(34) + "200%" + CHR$(34) + ">" + "</iframe>"
        'm$ = m$ + "<iframe src=" + CHR$(34) + "http://sw.twilightparadox.com:9506" + CHR$(34) + " style=" + CHR$(34) + "border:1px  solid" + CHR$(59) + CHR$(34) + " name=" + CHR$(34) + "Street" + CHR$(34) + " scroling=" + CHR$(34) + "auto" + CHR$(34) + " frameborder=" + CHR$(34) + "yes" + " align=" + CHR$(34) + "center" + CHR$(34) + " height = " + CHR$(34) + "150%" + CHR$(34) + " width = " + CHR$(34) + "200%" + CHR$(34) + ">" + "</iframe>"
        m$ = m$ + "</form></body></html>" + CRLF
        html$ = html$ + "<a href=" + CHR$(34) + "http://sw.twilightpardox.com:8088/" + CHR$(34) + "target=" + CHR$(34) + "_blank" + CHR$(34) + "><img src=" + CHR$(34) + "http://www.html.am/images/html-codes/links/boracay-white-beach-sunset-300x225.jpg" + CHR$(34) + "width=" + CHR$(34) + "70" + CHR$(34) + "height=" + CHR$(34) + "70" + CHR$(34) + "alt=" + CHR$(34) + "favicon.ico /></a>"
